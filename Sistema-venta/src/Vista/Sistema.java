...
public final class Sistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnUsuarios.setBackground(new java.awt.Color(0, 204, 204));
        ...
        TableVenta.setBackground(new java.awt.Color(204, 255, 255));
        ...
        TableCliente.setBackground(new java.awt.Color(204, 255, 255));
        ...
        TableProveedor.setBackground(new java.awt.Color(204, 255, 255));
        ...
        TableProducto.setBackground(new java.awt.Color(204, 255, 255));
        ...
        TableVentas.setBackground(new java.awt.Color(204, 255, 255));
        ...
        TableUsuarios.setBackground(new java.awt.Color(204, 255, 255));
    ...
    private void ExportarBotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExportarBotonActionPerformed
        ...
        try{
            if(laruta.trim().length()>0){
                backup = "C:\\Program Files\\MariaDB 10.7\\bin\\mysqldump --routines -hCarlitos -u" + instanciaMysql.getUsuario() + " -p" + instanciaMysql.getPassword() + " -B " +instanciaMysql.getBD() + " -r " + laruta + nombrescriptsql;
