...
public class Conexion {
    ...
    private static final String URL = "jdbc:mysql://Carlitos:3306/pruebaproyecto";
    ...
    public Connection getConnection() throws SQLException {
        connection = DriverManager.getConnection("jdbc:mysql://Carlitos:3306/pruebaproyecto", "root", "123abc");
